...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 12, 2022 at 07:54 AM
...
INSERT INTO `prescriptions` (`id`, `firstname`, `lastname`, `phone`, `dob`, `patient_weight`, `blood_pressure`, `pulse`, `patient_complaint`, `notes`, `duration`, `investigation_name`, `instrustion`, `diagnosis_name`, `comment`, `visit_after_days`, `medicines`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Patient One First Name', 'Patient One First Name', '01772235315', '03/10/1997', '65', '10', '20', 'xxxxxx', 'notesxxxx', '10', 'Inxxx', 'Insxxx', 'xxx', 'cxxx', '4', 'Napa', 1, NULL, NULL);
...
CREATE TABLE `users` (
  ...
  `prescriptions` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `users` (`id`, `role_id`, `name`, `phone`, `username`, `email`, `email_verified_at`, `password`, `image`, `about`, `remember_token`, `created_at`, `updated_at`, `type`, `admins`, `settings`, `prescriptions`) VALUES
(1, 1, 'Md.Admin', NULL, 'admin', 'admin@gmail.com', NULL, '$2y$10$mvkj.v/FqAewIVOO5DsNvuROLGRVbJDgjswttmmseBv/kKzozCJDa', NULL, NULL, NULL, NULL, NULL, NULL, '1', '1', NULL),
(2, 2, 'Md.Author', NULL, 'author', 'author@gmail.com', NULL, '$2y$10$B9qEjl6WJ77sHXaR3J//peh/zoCspgoPfyxEf4Fgcn0UejcP5LGSq', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, 3, 'Md.User', NULL, 'user', 'user@gmail.com', NULL, '$2y$10$V3Hbvb4AsABcXmwKxOnvGuVgj.GKttZYoKT0QU5YCUlW/8fxLO/QK', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(14, 1, 'Doctor Sayem', '01772235315', 'dr.sayem', 'dr.sayem@gmail.com', NULL, '$2y$10$3WrAiGLfqszcpzTJuFSl3.JvPv4gv/R3OomtHrQ5eAYxgNZWLtNym', NULL, NULL, NULL, NULL, NULL, '2', '1', '1', '1'),
(15, 1, 'Doctor Sumon Paul', '01882235315', 'dr.sumon', 'dr.sumon@gmail.com', NULL, '$2y$10$7tsD4zoxVsUrEoaE1mQiVeQihdGqUkwWJTuNte02Q3vgtyw8rcTNy', NULL, NULL, NULL, NULL, NULL, '2', NULL, '1', '1'),
(17, 1, 'Doctor Asif', '01772235315', 'dr.asif', 'dr.asif@gmail.com', NULL, '$2y$10$9ewfJCp5vGWdJFLmkqE.Z.mK0hz.WnMplXJlNWZaQlviQGcTfqtue', NULL, NULL, NULL, NULL, NULL, '2', NULL, '1', '1');
