...
<body class="cbp-spmenu-push">
    ...
    <script src="{{ asset('public/admin/backend/js') }}/Chart.bundle.js"></script>
    <script src="{{ asset('public/admin/backend/js') }}/utils.js"></script>
	...
	<script src="{{ asset('public/admin/backend/js') }}/SimpleChart.js"></script>
    <script>
        var graphdata1 = {
            linecolor: "#CCA300",
            title: "Monday",
